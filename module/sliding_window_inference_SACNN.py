...
def sliding_window_inference_sacnn(
    inputs: torch.Tensor,
    ...
    **kwargs: Any,
    ...
    importance_map = compute_importance_map(get_valid_patch_size(image_size, roi_size), mode=mode, sigma_scale=sigma_scale, device=device)
    print("c3 == ", importance_map.shape)
    # Perform predictions
    ...
    for slice_g in range(0, total_slices, sw_batch_size):
        ...
        print("c0 == ", window_data.shape)
        print("c1 == ", seg_prob.shape)
