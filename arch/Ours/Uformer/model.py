...
#########################################
# Downsample Block
class Downsample_Uformer(nn.Module):
    def __init__(self, in_channel, out_channel):
        super(Downsample_Uformer, self).__init__()
...
# Upsample Block
class Upsample_Uformer(nn.Module):
    def __init__(self, in_channel, out_channel):
        super(Upsample_Uformer, self).__init__()
...
class Uformer(nn.Module):
    def __init__(self, img_size=128, in_chans=3,
                 ...
                 token_projection='linear', token_mlp='ffn', se_layer=False,
                 dowsample=Downsample_Uformer, upsample=Upsample_Uformer, **kwargs):
        super().__init__()
